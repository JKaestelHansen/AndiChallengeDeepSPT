...
public_data_path = '_Data/public_data_challenge_v0/'
...
trajs_fov_ = []
traj_labs_fov_ = []
for root, dirs, files in os.walk(public_data_path+ f'track_{track}/'):
...
info_list = []
tf_list = []
for tf, tl in zip(trajs_fov_, trajs_fov_):
...
print(i)
andi_pred_formats_postprocessed_all[i], andi_pred_formats[i][3::4]

len(andi_pred_formats_postprocessed_all), len(andi_pred_formats)
# %%
...
for exp in range(N_EXP):
    ...
    path_exp = 'results/predictions/' + f'track_2/exp_{exp}/'
...
i = np.random.randint(0, len(andi_pred_formats))
print(i)
print(andi_pred_formats[i][0::4], andi_pred_formats_postprocessed_all[i][0::4])
print(andi_pred_formats[i][1::4], andi_pred_formats_postprocessed_all[i][1::4])
print(andi_pred_formats[i][2::4], andi_pred_formats_postprocessed_all[i][2::4])
print(andi_pred_formats[i][3::4], andi_pred_formats_postprocessed_all[i][3::4])
